...
// This verifies that the buffer passed in contains exactly the sequence of bytes that is generated by rand_r with the self.currentSeed
...
// This generates a sequence of bytes with rand_r(seed) and put it in the given buffer
-(NSInteger)read:(uint8_t *)buffer maxLength:(NSUInteger)length
{
    // Note: this method contains the extraneous local variables 'totalBlobSize' and 'totalBytes' because otherwise it contaminates profiling results. TOASK why?
